...
namespace KommuSoft.HaskellLibraries {
	...
	/// <summary>
	/// A class who implements the entire <code>Data.List</code> library of Haskell. Mainly by static methods, if usefull also by extension methods.
	/// </summary>
	/// <remarks>
	/// Some of the methods of Data.List are not implemented as extension methods, because they are already party of the LINQ framework. These methods are:
	/// <list type="bullet">
	/// <item>last</item>
	/// </list>
	/// </remarks>
	public static class DataList {
		...
		/// </returns>
		public static IEnumerable<X> Prepend<X> (X head, IEnumerable<X> tail) {
			yield return head;
			foreach(X x in tail) {
				yield return x;
			}
		...
		/// </remarks>
		public static IEnumerable<X> Prepend<X> (X head1, X head2, IEnumerable<X> tail) {
			yield return head1;
			yield return head2;
			foreach(X x in tail) {
				yield return x;
		...
		/// </remarks>
		public static IEnumerable<X> Append<X,SX> (this IEnumerable<X> xs, IEnumerable<SX> ys) where SX : X {
			foreach(X x in xs) {
				yield return x;
			}
			foreach(X y in ys) {
		...
		/// </returns>
		public static X Head<X> (this IEnumerable<X> xs) {
			IEnumerator<X> ie = xs.GetEnumerator();
			ie.MoveNext();
			return ie.Current;
		}
		/// <summary>
		...
		/// </returns>
		public static X Last<X> (IEnumerable<X> xs) {
			X t = default(X);
			foreach(X x in xs) {
				t = x;
			}
		...
		/// </returns>
		public static IEnumerable<X> Init<X> (this IEnumerable<X> xs) {
			IEnumerator<X> ie = xs.GetEnumerator();
			ie.MoveNext();
			X t = ie.Current;
			while(ie.MoveNext()) {
		...
		/// </remarks>
		public static bool Null<X> (this IEnumerable<X> xs) {
			IEnumerator<X> ie = xs.GetEnumerator();
			return !ie.MoveNext();
		}
		/// <summary>
		...
		/// </remarks>
		public static int Length<X> (this IEnumerable<X> xs) {
			return xs.Count();
		}
		/// <summary>
		...
		/// </para>
		/// </remarks>
		public static bool LengthLarger<X> (this IEnumerable<X> xs, int length) {
			IEnumerator<X> ie = xs.GetEnumerator();
		...
		/// </returns>
		public static IEnumerable<FX> Map<X,FX> (this IEnumerable<X> xs, Func<X,FX> f) {
			foreach(X x in xs) {
				yield return f(x);
			}
		}
		...
		/// </returns>
		public static IEnumerable<X> Reverse<X> (IEnumerable<X> xs) {
			Stack<X> sx = new Stack<X>();
			foreach(X x in xs) {
				sx.Push(x);
			}
			while(sx.Count > 0) {
		...
		/// <code>"a,b,c"</code>
		/// </example>
		public static IEnumerable<X> Intersperse<X> (this IEnumerable<X> xs, X inter) {
			IEnumerator<X> ie = xs.GetEnumerator();
			if(ie.MoveNext()) {
				yield return ie.Current;
				while(ie.MoveNext()) {
		...
		/// </remarks>
		public static IEnumerable<X> Intercalculate<X> (this IEnumerable<IEnumerable<X>> xss, IEnumerable<X> xs) {
		...
		/// </returns>
		public static IEnumerable<IEnumerable<X>> Transpose<X> (this IEnumerable<IEnumerable<X>> matrix) {
			IEnumerable<IEnumerable<X>> xss = matrix;
			while(!xss.Head().Null()) {
				IEnumerable<X> xxs = xss.Head();
				X x = xxs.Head();
				xss = xss.Tail();
				yield return Prepend(x,xss.Map(a => a.Head()));
				IEnumerable<X> xs = xxs.Tail();
		...
		/// </example>
		public static IEnumerable<IEnumerable<X>> Subsequences<X> (this IEnumerable<X> xs) {
			return Prepend(new X[0x00],xs.NonEmptySubsequences());
		}
		/// <summary>
		...
		/// </example>
		public static IEnumerable<IEnumerable<X>> NonEmptySubsequences<X> (this IEnumerable<X> list) {
			if(!list.Null()) {
				X x = list.Head();
				yield return new X[] {x};
				IEnumerable<X> xs = list.Tail();
				Func<IEnumerable<X>,IEnumerable<IEnumerable<X>>,IEnumerable<IEnumerable<X>>> f = (a,b) => Prepend(a,Prepend(x,a),b);
				foreach(IEnumerable<X> r in Foldr(f,new X[0x00][],NonEmptySubsequences(xs))) {
					yield return r;
				}
			}
		}
		...
		/// </example>
		public static IEnumerable<IEnumerable<X>> Permutations<X> (this IEnumerable<X> list) {
			return Prepend(list,perms(list,new X[0x00]));
		}
		private static IEnumerable<IEnumerable<X>> perms<X> (IEnumerable<X> tl, IEnumerable<X> il) {
			if(!tl.Null()) {
				X t = tl.Head();
				IEnumerable<X> ts = tl.Tail();
		...
		private static Tuple<IEnumerable<X>,IEnumerable<Y>> interleave<X,Y> (X t, IEnumerable<X> ts, Func<IEnumerable<X>,Y> f, IEnumerable<X> xs, IEnumerable<Y> r) {
			if(xs.Null()) {
				return new Tuple<IEnumerable<X>,IEnumerable<Y>>(ts,r);
			}
			else {
				Tuple<IEnumerable<X>,IEnumerable<Y>> tmp = interleave(t,ts,x => f(Prepend(xs.Head(),x)),xs.Tail(),r);
				IEnumerable<X> yus = Prepend(xs.Head(),tmp.Item1);
				return new Tuple<IEnumerable<X>,IEnumerable<Y>>(yus,Prepend(f(Prepend(t,yus)),tmp.Item2));
			}
		}
		#endregion
		...
		/// </remarks>
		public static X Foldl<X,Y> (Func<X,Y,X> f, X z, IEnumerable<Y> ys) {
			X t = z;
			foreach(Y y in ys) {
				t = f(t,y);
			}
		...
		/// </para>
		/// </remarks>
		public static X Foldl1<X> (Func<X,X,X> f, IEnumerable<X> xs) {
		...
		/// </remarks>
		public static Y Foldr<X,Y> (Func<X,Y,Y> f, Y z, IEnumerable<X> xs) {
			Stack<X> sx = new Stack<X>();
			foreach(X x in xs) {
				sx.Push(x);
			}
		...
		/// </para>
		/// </remarks>
		public static X Foldr1<X> (Func<X,X,X> f, IEnumerable<X> xs) {
		...
		/// </returns>
		public static IEnumerable<X> Concat<X> (this IEnumerable<IEnumerable<X>> xss) {
			foreach(IEnumerable<X> xs in xss) {
				foreach(X x in xs) {
					yield return x;
				}
			}
		...
		/// </returns>
		public static IEnumerable<Y> ConcatMap<X,Y> (this IEnumerable<X> xs, Func<X,IEnumerable<Y>> f) {
			foreach(X x in xs) {
				foreach(Y y in f(x)) {
					yield return y;
				}
		...
		/// </returns>
		public static bool Any<X> (IEnumerable<X> list, Predicate<X> predicate) {
			foreach(X x in list) {
				if(predicate(x)) {
					return true;
				}
		...
		/// </returns>
		public static bool All<X> (IEnumerable<X> list, Predicate<X> predicate) {
			foreach(X x in list) {
				if(!predicate(x)) {
					return false;
				}
		...
		/// </returns>
		public static X Sum<X> (this IEnumerable<X> list) where X : INumeric<X> {
		...
		/// </returns>
		public static X Product<X> (this IEnumerable<X> list) where X : INumeric<X> {
		...
		/// <see cref="M:DataList.MaximumBy"/> which allows the programmer to supply their own comparison function.
		/// </summary>
		/// <param name="list">
		...
		/// </returns>
		public static X Maximum<X> (this IEnumerable<X> list) where X : IComparable<X> {
		...
		/// <see cref="M:DataList.MinimumBy"/> which allows the programmer to supply their own comparison function.
		/// </summary>
		/// <param name="list">
		...
		/// </returns>
		public static X Minimum<X> (this IEnumerable<X> list) where X : IComparable<X> {
		...
		#region Scans
		/// <summary>
		/// A method similar to <see cref="M:DataList.Foldl"/> but returns the list of successive reduced values from the left.
		/// </summary>
		/// <param name="f">
		...
		/// </param>
		/// <returns>
		/// A lazy generated list where the <i>i</i>-th element is the <see cref="M:DataList.Foldl"/> of the sublist of 0 to <i>i-1</i>.
		/// </returns>
		/// <remarks>
		/// Note that <code>DataList.Scanl(f,z,ys).Last()</code> is equal to <code>DataList.Foldl(f,z,ys)</code>
		/// </remarks>
		public static IEnumerable<X> Scanl<X,Y> (Func<X,Y,X> f, X z, IEnumerable<Y> ys) {
			X t = z;
			yield return t;
			foreach(Y y in ys) {
				t = f(t,y);
		...
		/// <summary>
		/// A variant of <see cref="M:DataList.Scanl"/> that has no starting value.
		/// </summary>
		/// <param name="f">
		/// The given function to evaluate the following element.
		/// </param>
		...
		/// </param>
		/// <returns>
		/// A lazy generated list where the <i>i</i>-th element is the <see cref="M:DataList.Foldl1"/> on the sublist of 0 to <i>i-1</i>.
		/// </returns>
		public static IEnumerable<X> Scanl1<X> (Func<X,X,X> f, IEnumerable<X> xs) {
			return Scanl(f,xs.Head(),xs.Tail());
		}
		/// <summary>
		/// The right-to-left dual of <see cref="M:DataList.Scanl"/>.
		/// </summary>
		/// <param name="f">
		/// The given function to evaluate the following element.
		/// </param>
		...
		/// </param>
		/// <returns>
		/// A lazy generated list where the <i>i</i>-th element is the <see cref="M:DataList.Foldr"/> of the sublist of <i>i</i> to <i>n</i>.
		/// </returns>
		/// <remarks>
		/// Note that <code>DataList.Scanr(f,z,ys).Head()</code> is equal to <code>DataList.Foldr(f,z,ys)</code>
		/// </remarks>
		public static IEnumerable<X> Scanr<X,Y> (Func<X,Y,X> f, X z, IEnumerable<Y> ys) {
			Stack<Y> sy = new Stack<Y>();
			foreach(Y y in ys) {
				sy.Push(y);
			}
			X t = z;
		...
		/// <summary>
		/// A variant of <see cref="M:DataList.Scanr"/> that has no starting value argument.
		/// </summary>
		/// <param name="f">
		/// The given function to evaluate the following element.
		/// </param>
		...
		/// </param>
		/// <returns>
		/// A lazy generated list where the <i>i</i>-th element is the <see cref="M:DataList.Foldr1"/> of the sublist of <i>i</i> to <i>n</i>.
		/// </returns>
		public static IEnumerable<X> Scanr1<X> (Func<X,X,X> f, IEnumerable<X> xs) {
			return Scanr(f,xs.Last(),xs.Init());
		}
		#endregion
		#region AccumulatingMaps
		/// <summary>
		/// A method who behaves like a combination of <see cref="M:DataList.Map"/> and <see cref="M:DataList.Foldl"/>; it applies a function to
		...
		/// </returns>
		public static Tuple<Acc,IEnumerable<Y>> MapAccumL<X,Y,Acc> (Func<Acc,X,Tuple<Acc,Y>> f, Acc z, IEnumerable<X> xs) {
			return new Tuple<Acc, IEnumerable<Y>>(Foldl((a,b) => f(a,b).Item1,z,xs),mapAccumLList(f,z,xs));
		}
		private static IEnumerable<Y> mapAccumLList<X,Y,Acc> (Func<Acc,X,Tuple<Acc,Y>> f, Acc z, IEnumerable<X> xs) {
			Acc t = z;
			Tuple<Acc,Y> res;
			foreach(X x in xs) {
				res = f(t,x);
		...
		/// <summary>
		/// A method who behaves like a combination of <see cref="M:DataList.Map"/> and <see cref="M:DataList.Foldr"/>; it applies a function to
		...
		/// who is generated lazy.
		/// </returns>
		public static Tuple<Acc,IEnumerable<Y>> MapAccumR<X,Y,Acc> (Func<Acc,X,Tuple<Acc,Y>> f, Acc z, IEnumerable<X> xs) {
			return new Tuple<Acc, IEnumerable<Y>>(Foldl((a,b) => f(a,b).Item1,z,xs),mapAccumRList(f,z,xs));
		}
		private static IEnumerable<Y> mapAccumRList<X,Y,Acc> (Func<Acc,X,Tuple<Acc,Y>> f, Acc z, IEnumerable<X> xs) {
			Stack<X> sx = new Stack<X>();
			foreach(X x in xs) {
				sx.Push(x);
			}
		...
		/// </returns>
		public static IEnumerable<X> Iterate<X> (Func<X,X> f, X x) {
			X t = x;
			while(true) {
				yield return t;
				t = f(t);
		...
		/// </returns>
		public static IEnumerable<X> Repeat<X> (X x) {
			while(true) {
				yield return x;
			}
		}
		...
		/// instance of the more general <see cref="M:DataList.GenericReplicate"/>, in which <paramref name="n"/> may be
		...
		/// </returns>
		public static IEnumerable<X> Replicate<X> (int n, X x) {
			for(int i = 0; i < n; i++) {
				yield return x;
			}
		}
		...
		/// </returns>
		public static IEnumerable<X> Cycle<X> (IEnumerable<X> list) {
			while(true) {
				foreach(X x in list) {
					yield return x;
				}
		...
		#region Unfolding
		/// <summary>
		/// The "dual" method of the <see cref="M:DataList.Foldr"/>: while <see cref="M:DataList.Foldr"/> reduces a list to a
		...
		/// </para><para>
		/// As the name suggests, in some cases Unfoldr can undo <see cref="M:DataList.Foldr"/> operations:
		...
		/// </remarks>
		public static IEnumerable<X> Take<X> (this IEnumerable<X> xs, int n) {
			IEnumerator<X> ie = xs.GetEnumerator();
		...
		/// </remarks>
		public static IEnumerable<X> Drop<X> (this IEnumerable<X> xs, int n) {
			IEnumerator<X> ie = xs.GetEnumerator();
			for(int i = 0; i < n && ie.MoveNext(); i++);
			while(ie.MoveNext()) {
				yield return ie.Current;
		...
		/// </returns>
		public static Tuple<IEnumerable<X>,IEnumerable<X>> SplitAt<X> (this IEnumerable<X> xs, int n) {
			return new Tuple<IEnumerable<X>, IEnumerable<X>>(xs.Take(n),xs.Drop(n));
		}
		/// <summary>
		...
		/// </returns>
		public static IEnumerable<X> TakeWhile<X> (this IEnumerable<X> xs, Predicate<X> p) {
			IEnumerator<X> ie = xs.GetEnumerator();
		...
		/// <summary>
		/// Generates the suffix remaining after <see cref="M:DataList.TakeWhile"/> performed on <paramref name="xs"/> and <paramref name="p"/>.
		/// </summary>
		/// <param name="xs">
		...
		/// </returns>
		public static IEnumerable<X> DropWhile<X> (this IEnumerable<X> xs, Predicate<X> p) {
			IEnumerator<X> ie = xs.GetEnumerator();
			while(ie.MoveNext() && p(ie.Current));
			do {
				yield return ie.Current;
		...
		/// </returns>
		public static IEnumerable<X> DropWhileEnd<X> (this IEnumerable<X> xs, Predicate<X> p) {
			Queue<X> qx = new Queue<X>();
			IEnumerator<X> ie = xs.GetEnumerator();
		...
		/// </returns>
		public static Tuple<IEnumerable<X>,IEnumerable<X>> Span<X> (this IEnumerable<X> xs, Predicate<X> p) {
			return new Tuple<IEnumerable<X>,IEnumerable<X>>(xs.TakeWhile(p),xs.DropWhile(p));
		}
		/// <summary>
		/// Applies a predicate to a list <paramref name="xs"/> and returns a tuple where the first element is the longest prefix (possibly empty)
		...
		/// </returns>
		public static Tuple<IEnumerable<X>,IEnumerable<X>> Break<X> (this IEnumerable<X> xs, Predicate<X> p) {
			return new Tuple<IEnumerable<X>,IEnumerable<X>>(xs.TakeWhile(a => !p(a)),xs.DropWhile(a => !p(a)));
		}
		/// <summary>
		...
		/// </returns>
		public static Maybe<IEnumerable<X>> StripPrefix<X> (IEnumerable<X> prefix, IEnumerable<X> list) {
			IEnumerator<X> ie = list.GetEnumerator();
			int i = 0;
			foreach(X px in prefix) {
				if(!ie.MoveNext() || px.Equals(ie.Current)) {
					return new Maybe<IEnumerable<X>>();
				}
				i++;
			}
			return new Maybe<IEnumerable<X>>(list.Drop(i));
		}
		/// <summary>
		...
		/// </example>
		/// <remarks>
		/// This method is a special case of <see cref="M:DataList.GroupBy"/> wich allows the programmer to supply their own equality test.
		/// </remarks>
		public static IEnumerable<IEnumerable<X>> Group<X> (this IEnumerable<X> xs) {
			IEnumerator<X> ie = xs.GetEnumerator();
			List<X> xl = new List<X>();
			bool nxt = ie.MoveNext();
			while(nxt) {
				X old = ie.Current;
				xl = new List<X>();
		...
		/// </example>
		public static IEnumerable<IEnumerable<X>> Inits<X> (this IEnumerable<X> xs) {
			IEnumerator<X> ie = xs.GetEnumerator();
			yield return new X[0x00];
		...
		/// </example>
		public static IEnumerable<IEnumerable<X>> Tails<X> (this IEnumerable<X> xs) {
			IEnumerator<X> ie = xs.GetEnumerator();
		...
		/// </returns>
		public static bool IsPrefixOf<X> (IEnumerable<X> prefix, IEnumerable<X> list) {
			IEnumerator<X> ie = list.GetEnumerator();
			foreach(X x in prefix) {
		...
		/// </returns>
		public static bool IsSuffixOf<X> (IEnumerable<X> suffix, IEnumerable<X> list) {
			List<X> sfx = new List<X>(suffix);
			int i, f = sfx.Count;
			if(f == 0x00) {
				return true;
			}
		...
		/// </example>
		public static bool IsInfixOf<X> (IEnumerable<X> infix, IEnumerable<X> list) {
			List<X> w = new List<X>(infix);
			List<X> s = new List<X>(list);
			int wc = w.Count;
			int[] t = new int[wc];
			kmpTable(w,t);
			int i = 0x00, m = 0x00;
		...
		/// </returns>
		public static IEnumerable<int> InfixIndices<X> (IEnumerable<X> infix, IEnumerable<X> list) {
			List<X> w = new List<X>(infix);
			List<X> s = new List<X>(list);
			int wc = w.Count;
			int[] t = new int[wc];
		...
		private static void kmpTable<X> (List<X> w, int[] t) {
			int pos = 0x02;
			int cnd = 0x00;
			t[0x00] = -0x01;
			int wl = t.Length;
		...
		/// </returns>
		public static bool Elem<X> (this IEnumerable<X> xs, X x) {
			foreach(X xi in xs) {
				if(xi.Equals(x)) {
					return true;
				}
		...
		/// <summary>
		/// The negation of <see cref="M:DataList.Elem"/>.
		/// </summary>
		/// <param name="xs">
		/// The given list to check membership on.
		/// </param>
		...
		/// </returns>
		public static bool NotElem<X> (this IEnumerable<X> xs, X x) {
			return !Elem(xs,x);
		}
		#endregion
		/// <summary>
		...
		/// </returns>
		public static Maybe<Y> Lookup<X,Y> (this IEnumerable<Tuple<X,Y>> xys, X x) {
			foreach(Tuple<X,Y> xy in xys) {
		...
		/// </returns>
		public static Maybe<X> Find<X> (this IEnumerable<X> xs, Predicate<X> p) {
			foreach(X x in xs) {
				if(p(x)) {
					return x;
				}
		...
		/// </returns>
		public static IEnumerable<X> Filter<X> (this IEnumerable<X> xs, Predicate<X> p) {
			foreach(X x in xs) {
				if(p(x)) {
					yield return x;
				}
		...
		/// </returns>
		public static Tuple<IEnumerable<X>,IEnumerable<X>> Partition<X> (this IEnumerable<X> xs, Predicate<X> p) {
			return new Tuple<IEnumerable<X>,IEnumerable<X>>(xs.Filter(p),xs.Filter(x => !p(x)));
		}
		#endregion
		#endregion
		...
		/// </returns>
		/// <exception cref="T:IndexOutOfRangeException">If the index is smaller than zero, or larger or equal to the length of the given list <paramref name="xs"/>.</exception>
		public static X IndexOperator<X> (this IEnumerable<X> xs, int index) {
			if(index < 0x00) {
		...
		/// no such element.
		/// </returns>
		public static Maybe<int> ElemIndex<X> (this IEnumerable<X> xs, X x) {
			int index = 0x00;
			foreach(X xi in xs) {
				if(xi.Equals(x)) {
		...
		/// <summary>
		/// An extension of <see cref="M:DataLIst.ElementIndex"/>, by returning the indices of all elements equal to the query element <paramref name="x"/>,
		/// in ascending order.
		/// </summary>
		/// <param name="xs">
		/// The list to search for the index of the given element <paramref name="x"/>.
		...
		/// </returns>
		public static IEnumerable<int> ElemIndices<X> (this IEnumerable<X> xs, X x) {
			int index = 0x00;
			foreach(X xi in xs) {
				if(xi.Equals(x)) {
					yield return index;
		...
		/// </returns>
		public static Maybe<int> FindIndex<X> (this IEnumerable<X> xs, Predicate<X> p) {
			int index = 0x00;
			foreach(X x in xs) {
				if(p(x)) {
					return new Maybe<int>(index);
		...
		/// <summary>
		/// An extension of <see cref="M:DataList.FindIndex"/>, by returning the indices of all elements satisfying the given predicate <paramref name="p"/>, in
		/// ascending order.
		/// </summary>
		/// <param name="xs">
		...
		/// </returns>
		public static IEnumerable<int> FindIndices<X> (this IEnumerable<X> xs, Predicate<X> p) {
			int index = 0x00;
			foreach(X x in xs) {
				if(p(x)) {
					yield return index;
		...
		/// <summary>
		/// A method taking three lists and returns a list of corresponding triples, analogues to <see cref="M:DataList.Zip"/>.
		/// </summary>
		/// <param name="ss">
		/// The first list to zip.
		/// </param>
		...
		/// <summary>
		/// A method taking four lists and returns a list of corresponding quadruples, analogues to <see cref="M:DataList.Zip"/>.
		/// </summary>
		/// <param name="ss">
		/// The first list to zip.
		/// </param>
		...
		/// <summary>
		/// A method taking five lists and returns a list of corresponding five-tuples, analogues to <see cref="M:DataList.Zip"/>.
		/// </summary>
		/// <param name="ss">
		/// The first list to zip.
		/// </param>
		...
		/// <summary>
		/// A method taking six lists and returns a list of corresponding six-tuples, analogues to <see cref="M:DataList.Zip"/>.
		/// </summary>
		/// <param name="ss">
		/// The first list to zip.
		/// </param>
		...
		/// <summary>
		/// A method taking seven lists and returns a list of corresponding seven-tuples, analogues to <see cref="M:DataList.Zip"/>.
		/// </summary>
		/// <param name="ss">
		/// The first list to zip.
		/// </param>
		...
		/// <summary>
		/// A method taking eight lists and returns a list of corresponding eight-tuples, analogues to <see cref="M:DataList.Zip"/>.
		/// </summary>
		/// <param name="ss">
		/// The first list to zip.
		/// </param>
		...
		/// <summary>
		/// A generaliziation of <see cref="M:DataList.Zip"/> by zipping with the function <paramref name="f"/> given as the first argument,
		...
		/// analogous to <see cref="M:DataList.ZipWith"/>.
		/// </summary>
		/// <param name="f">
		...
		/// <summary>
		/// Transforms a list of triples and returns three lists, analoguous to <see cref="M:DataList.Unzip"/>.
		/// </summary>
		/// <param name="tuples">
		...
		/// <summary>
		/// Transforms a list of quadruples and returns four lists, analoguous to <see cref="M:DataList.Unzip"/>.
		/// </summary>
		/// <param name="tuples">
		/// The given list of tuples.
		/// </param>
		...
		/// <summary>
		/// Transforms a list of five-tuples and returns five lists, analoguous to <see cref="M:DataList.Unzip"/>.
		/// </summary>
		/// <param name="tuples">
		/// The given list of tuples.
		/// </param>
		...
		/// <summary>
		/// Transforms a list of six-tuples and returns six lists, analoguous to <see cref="M:DataList.Unzip"/>.
		/// </summary>
		/// <param name="tuples">
		/// The given list of tuples.
		/// </param>
		...
		/// <summary>
		/// Transforms a list of seven-tuples and returns seven lists, analoguous to <see cref="M:DataList.Unzip"/>.
		/// </summary>
		/// <param name="tuples">
		/// The given list of tuples.
		/// </param>
		...
		/// <summary>
		/// Transforms a list of eight-tuples and returns eight lists, analoguous to <see cref="M:DataList.Unzip"/>.
		/// </summary>
		/// <param name="tuples">
		/// The given list of tuples.
		/// </param>
		...
		/// <summary>
		/// The inverse operation of <see cref="M:DataList.Lines"/>. It joins lines, after appending a terminating newline to each.
		/// </summary>
		/// <param name="lines">
		...
		/// <summary>
		/// The inverse operation of <see cref="M:DataList.Words"/> it joins words with separating spaces.
		/// </summary>
		/// <param name="words">
		...
		/// <remarks>
		/// <para>
		/// It is a special case of <see cref="M:DataList.NubBy"/> which allows the programmer to supply their own equality test.
		/// </para><para>
		/// The time complexity of this function is <i>O(n^2)</i> with <i>n</i> the length of the original list.
		/// </para>
		/// </remarks>
		public static IEnumerable<X> Nub<X> (this IEnumerable<X> xs) {
			HashSet<X> hs = new HashSet<X>();
			foreach(X x in xs) {
				if(hs.Add(x)) {
					yield return x;
				}
		...
		/// </example>
		public static IEnumerable<X> Delete<X> (this IEnumerable<X> xs, X x) {
			IEnumerator<X> ie = xs.GetEnumerator();
		...
		/// </para>
		/// </remarks>
		public static IEnumerable<X> Difference<X> (IEnumerable<X> xs, IEnumerable<X> ys) {
			HashSet<X> toRemove = new HashSet<X>(ys);
			foreach(X x in xs) {
		...
		/// </example>
		public static IEnumerable<X> Union<X> (IEnumerable<X> xs, IEnumerable<X> ys) {
			HashSet<X> hs = new HashSet<X>();
			foreach(X x in xs) {
				yield return x;
				hs.Add(x);
		...
		/// <summary>
		/// Takes the list intersection of two lists. If the first list contains duplicates, so will the result. It is a special case of <see cref="M:DataList.IntersectBy"/>,
		...
		/// </example>
		public static IEnumerable<X> Intersect<X> (IEnumerable<X> xs, IEnumerable<X> ys) {
			HashSet<X> hs = new HashSet<X>();
			IEnumerator<X> ie = ys.GetEnumerator();
			foreach(X x in xs) {
				if(!hs.Contains(x)) {
					while(ie.MoveNext()) {
						X t = ie.Current;
		...
		/// <summary>
		/// This method implements a stable sorting algorithm. It is a special case of <see cref="M:DataList.SortBy"/>, which
		...
		/// </returns>
		public static IEnumerable<X> Sort<X> (this IEnumerable<X> list) where X : IComparable<X> {
			List<X> la = new List<X>(list);
			List<X> lb = new List<X>(list);
			int n = la.Count;
			innerMergeSort(la,lb,0x00,n);
			return lb;
		}
		private static void innerMergeSort<X> (List<X> read, List<X> write, int frm, int to) where X : IComparable<X> {
			if(to-frm > 0x02) {
				int mid = (to+frm)>>0x01;
		...
		/// a special case of <see cref="M:DataList.InsertBy"/>, which allows the programmer to supply their own comparison function.
		/// </summary>
		/// <param name="xs">
		...
		/// </returns>
		public static IEnumerable<X> Insert<X> (this IEnumerable<X> xs, X x) where X : IComparable<X> {
			IEnumerator<X> ie = xs.GetEnumerator();
			bool nxt = ie.MoveNext();
		...
		/// <summary>
		/// A method behaving just like <see cref="M:DataList.Nub"/>, except it uses a user-supplied equality predicate instead of the
		/// overloaded <see cref="M:Object.Equals"/> function.
		/// </summary>
		/// <param name="xs">
		...
		/// </returns>
		public static IEnumerable<X> NubBy<X> (this IEnumerable<X> xs, EqualityFunction<X> equalf) {
		...
		/// <summary>
		/// A method behaving like <see cref="M:DataList.Delete"/>, but takes a user-supplied equality predicate.
		/// </summary>
		/// <param name="xs">
		...
		/// missing.
		/// </returns>
		public static IEnumerable<X> DeleteBy<X> (this IEnumerable<X> xs, EqualityFunction<X> equalf, X x) {
			IEnumerator<X> ie = xs.GetEnumerator();
		...
		/// </returns>
		public static IEnumerable<X> DeleteFirstsBy<X> (this IEnumerable<X> xs, EqualityFunction<X> equalf, IEnumerable<X> deletelist) {
			LinkedList<X> ll = new LinkedList<X>(deletelist);
			foreach(X x in xs) {
				LinkedListNode<X> llf = ll.First;
				bool allowed = true;
				while(llf != null) {
		...
		/// <summary>
		/// The UnionBy function is the non-overloaded version of <see cref="M:DataList.Union"/>.
		/// </summary>
		/// <param name="xs">
		/// The first list to calculate the union from.
		/// </param>
		...
		/// </returns>
		public static IEnumerable<X> UnionBy<X> (IEnumerable<X> xs, EqualityFunction<X> equalf, IEnumerable<X> ys) {
		...
		/// </returns>
		public static IEnumerable<X> IntersectBy<X> (IEnumerable<X> xs, EqualityFunction<X> equalf, IEnumerable<X> ys) {
			IEnumerator<X> ie = ys.GetEnumerator();
			List<X> ll = new List<X>();
			foreach(X x in xs) {
		...
		/// <summary>
		/// The GroupBy function is the non-overloaded version of <see cref="M:DataList.Group"/>.
		/// </summary>
		/// <param name="xs">
		...
		/// </returns>
		public static IEnumerable<IEnumerable<X>> GroupBy<X> (this IEnumerable<X> xs, EqualityFunction<X> equalf) {
			IEnumerator<X> ie = xs.GetEnumerator();
			List<X> xl = new List<X>();
			bool nxt = ie.MoveNext();
			while(nxt) {
		...
		/// <summary>
		/// The non-overloaded version of <see cref="M:DataList.Sort"/>.
		/// </summary>
		/// <param name="list">
		...
		/// </returns>
		public static IEnumerable<X> SortBy<X> (this IEnumerable<X> list, OrderingFunction<X> ord) where X : IComparable<X> {
			List<X> la = new List<X>(list);
			List<X> lb = new List<X>(list);
			int n = la.Count;
		...
		private static void innerMergeSortBy<X> (OrderingFunction<X> ord, List<X> read, List<X> write, int frm, int to) where X : IComparable<X> {
			if(to-frm > 0x02) {
				int mid = (to+frm)>>0x01;
				innerMergeSort(write,read,frm,mid);
				innerMergeSort(write,read,mid,to);
		...
		/// <summary>
		/// The non-overloaded version of <see cref="M:DataList.Insert"/>.
		/// </summary>
		/// <param name="xs">
		...
		/// </returns>
		public static IEnumerable<X> InsertBy<X> (this IEnumerable<X> xs, OrderingFunction<X> ord, X x) {
			IEnumerator<X> ie = xs.GetEnumerator();
			bool nxt = ie.MoveNext();
		...
		/// </returns>
		public static X MaximumBy<X> (this IEnumerable<X> xs, OrderingFunction<X> ord) {
			IEnumerator<X> ie = xs.GetEnumerator();
			ie.MoveNext();
			X x = ie.Current;
			while(ie.MoveNext()) {
		...
		/// </returns>
		public static X MinimumBy<X> (this IEnumerable<X> xs, OrderingFunction<X> ord) {
			IEnumerator<X> ie = xs.GetEnumerator();
			ie.MoveNext();
			X x = ie.Current;
			while(ie.MoveNext()) {
		...
		/// <summary>
		/// The overloaded version of <see cref="M:DataList.Length"/>. In particular, instead of returning an <see cref="T:int"/>,
		/// it returns any type which is an instance of <see cref="T:INumeric"/>. It is, however, less efficient than length.
		/// </summary>
		/// <param name="xs">
		/// The list of elements to calculate the length from.
		/// </param>
		/// <param name="number">
		/// An instance of the type of number the programmer want to be returned (for instance <see cref="T:BigInteger"/>).
		/// </param>
		/// <returns>
		/// A numeric type who stores the length of the given list.
		/// </returns>
		public static I GenericLength<I,X> (this IEnumerable<X> xs, I number) where I : INumeric<I> {
			I len = number.Zero;
			foreach(X x in xs) {
		...
		/// <summary>
		/// The overloaded version of <see cref="M:DataList.Take"/>, which accepts a <see cref="T:IIntegral"/> value as the number
		/// of elements to take.
		/// </summary>
		/// <param name="xs">
		...
		/// </returns>
		public static IEnumerable<X> GenericTake<X,I> (this IEnumerable<X> xs, I integer) where I : IIntegral<I> {
			IEnumerator<X> ie = xs.GetEnumerator();
		...
		/// <summary>
		/// The overloaded version of <see cref="M:DataList.Drop"/>, which accepts a <see cref="T:IIntegral"/> value as the number
		/// of elements to take.
		/// </summary>
		/// <param name="xs">
		/// The original list of elements to generate a sublist from.
		...
		/// </returns>
		public static IEnumerable<X> GenericDrop<X,I> (this IEnumerable<X> xs, I integer) where I : IIntegral<I> {
			IEnumerator<X> ie = xs.GetEnumerator();
			while(ie.MoveNext() && integer.Compare(integer,integer.Zero) > 0x00) {
				integer = integer.Subtract(integer,integer.One);
			}
		...
		/// <summary>
		/// The overloaded version of <see cref="M:DataList.SplitAt"/>, which accepts any <see cref="T:IIntegral"/> value as the position
		/// at which to split.
		/// </summary>
		/// <param name="xs">
		...
		/// </returns>
		public static Tuple<IEnumerable<X>,IEnumerable<X>> GenericSplitAt<X,I> (this IEnumerable<X> xs, I integer) where I : IIntegral<I> {
			return new Tuple<IEnumerable<X>,IEnumerable<X>>(xs.GenericTake(integer),xs.GenericDrop(integer));
		}
		/// <summary>
		/// The overloaded version of <see cref="M:DataList.IndexOperator"/>. Which accepts any <see cref="T:IIntegral"/> value as the position at which to split.
		/// </summary>
		/// <param name="xs">
		...
		/// </returns>
		/// <exception cref="T:IndexOutOfRangeException">If the index is smaller than zero, or larger or equal to the length of the given list <paramref name="xs"/>.</exception>
		public static X GenericIndex<X,I> (this IEnumerable<X> xs, I integer) where I : IIntegral<I> {
		...
		/// <summary>
		/// The overloaded version of <see cref="M:DataList.Replicate"/>, which accepts any <see cref="T:IIntegral"/> value as
		...
		/// </returns>
		public static IEnumerable<X> GenericReplicate<X,I> (I integer, X x) where I : IIntegral<I> {
